...
public class TwitterClient extends OAuthBaseClient {
	...
	public static final int HOME_TIMELINE_COUNT = 40;
	public static final int HOME_TIMELINE_SINCEID = 1;
	...
	public void getHomeTimeline(JsonHttpResponseHandler handler) {
		...
		params.put("count", HOME_TIMELINE_COUNT);
		params.put("since_id", HOME_TIMELINE_SINCEID);
